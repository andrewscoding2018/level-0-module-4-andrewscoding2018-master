void setup() {
        size(1373, 1000);    
  PImage waldo = loadImage("walado.jpg"); // 5. Change this to match your file name.
         waldo.resize(1373,1000);
      image(waldo, 0, 0);
...
if(mousePressed || mouseX == 594 || mouseY == 724)
{
  println("Waldo is found!!!!!");
playWoohoo();
}
else if(mousePressed || mouseX != 594 || mouseY != 724)
{
  println("Doh!!!!!");
playDoh();
}
